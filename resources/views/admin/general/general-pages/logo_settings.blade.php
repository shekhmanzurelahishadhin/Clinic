            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{route('store.logo')}}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="frontend_logo_image" class="form-control">
                        @if($logo!=null)
                            <img src="{{asset($logo->frontend_logo_image)}}" width="100" height="50" alt="">
                        @endif
                    </div>
                    <div class="form-group">
                        <label>Backend Header Logo</label>
                        <input type="file" name="backend_logo_image" class="form-control">
                        @if($logo!=null)
                            <img src="{{asset($logo->backend_logo_image)}}" width="100" height="50" alt="">
                        @endif
                    </div>
                    <div class="form-group">
                        <label>Frontend Footer Logo</label>
                        <input type="file" name="footer_logo_image" class="form-control">
                        @if($logo!=null)
                            <img src="{{asset($logo->footer_logo_image)}}" width="100" height="50" alt="">
                        @endif
                    </div>
                    <div class="form-group">
                        <label>Favicon</label>
